...
class STTBuilder(gegede.builder.Builder):
    ...
    def construct(self, geom):
        ...
        self.sttDim[2] = (  self.nRadiatorModules*self.radiatorMod_z[2]
                          + self.nTargetModules  *( self.targetDim[2] + 2*self.stPlaneDim[2] ) )
