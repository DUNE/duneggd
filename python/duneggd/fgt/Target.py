...
class TargetPlaneBuilder(gegede.builder.Builder):
    ...
    def construct(self, geom):
        ...
        targetTube    = geom.shapes.Tubs(self.name+'Tube', 
                                         rmin = '0cm',              
                                         rmax = self.tTube_outerDia, 
                                         dz   = self.tTube_length)
        ...
        self.targetPlaneDim = [ self.tTube_length, self.tTube_length, self.tTube_outerDia ] # is there more space than just outerDia?
        ...
        if( calculatedWidth > self.targetPlaneDim[0] ):
            ...
            self.tTube_interval = ( self.targetPlaneDim[0] - 2*self.tTube_outerDia )/(self.nTubesPerTarget-1)
