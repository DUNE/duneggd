...
void drawLArFD()
{
  ...
  /* gGeoManager->FindVolumeFast("volRadioRockShell")->SetTransparency(31); */
  /* gGeoManager->FindVolumeFast("volRadioRockShell")->SetLineColor(kRed); */
  
  /* ggeomanager->FindVolumeFast("volFieldCageHorBar")->SetVisibility(1); */
  /* gGeoManager->FindVolumeFast("volFieldCageHorBar")->SetTransparency(31); */
  /* gGeoManager->FindVolumeFast("volFieldCageHorBar")->SetLineColor(kRed); */

  /* gGeoManager->FindVolumeFast("volFieldCageVerBar")->SetVisibility(1); */
  /* gGeoManager->FindVolumeFast("volFieldCageVerBar")->SetTransparency(31); */
  /* gGeoManager->FindVolumeFast("volFieldCageVerBar")->SetLineColor(kRed); */

  
  /* gGeoManager->FindVolumeFast("volLArInCryo"		)->SetVisibility(0); */
  /* gGeoManager->FindVolumeFast("volColdCryoLayer1"	)->SetVisibility(0); */
  /* gGeoManager->FindVolumeFast("volColdCryoLayer2"	)->SetVisibility(0); */
  /* gGeoManager->FindVolumeFast("volColdCryoLayer3"	)->SetVisibility(0); */
  /* gGeoManager->FindVolumeFast("volWarmSkin"		)->SetVisibility(0); */
  /* gGeoManager->FindVolumeFast("volTPCActive"		)->SetVisibility(0); */
  /* gGeoManager->FindVolumeFast("volGaseousArgon"		)->SetVisibility(0); */
  /* gGeoManager->FindVolumeFast("volRadioRockShell"       )->SetVisibility(0); */
  /* gGeoManager->FindVolumeFast("volTPCPlaneU"       )->SetVisibility(0); */
  /* gGeoManager->FindVolumeFast("volTPCPlaneV"       )->SetVisibility(0); */
  /* gGeoManager->FindVolumeFast("volTPCPlaneZ"       )->SetVisibility(0); */
