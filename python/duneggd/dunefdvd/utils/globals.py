...
class Params:
    ...
    def SetDerived(self):
        ...
        cls._tpc['widthCRM'] = cls._tpc['widthPCBActive'] + 2 * cls._tpc['borderCRM']
        cls._tpc['lengthCRM'] = cls._tpc['lengthPCBActive'] + 2 * cls._tpc['borderCRM']
        ...
        if cls._world['workspace'] == 4:
            ...
            cls._tpc['nCRM_x'] = 1
        # 1x8x14
        if cls._world['workspace'] == 5:
            cls._tpc['nCRM_y'] = 4 * 2
            cls._tpc['nCRM_z'] = 20 * 2
            cls._tpc['nCRM_x'] = 1
        # 2x8x6
        if cls._world['workspace'] == 6:
            cls._tpc['nCRM_y'] = 4 * 2
            cls._tpc['nCRM_z'] = 3 * 2
            cls._tpc['nCRM_x'] = 2
        # 2x8x14
        if cls._world['workspace'] == 7:
            cls._tpc['nCRM_y'] = 4 * 2
            cls._tpc['nCRM_z'] = 7 * 2
            cls._tpc['nCRM_x'] = 2

        cls._tpc['widthTPCActive'] = cls._tpc['nCRM_y'] * (cls._tpc['widthCRM'] + cls._tpc['borderCRP'])
        cls._tpc['lengthTPCActive'] = cls._tpc['nCRM_z'] * (cls._tpc['lengthCRM'] + cls._tpc['borderCRP'])
        ...
        if not cls._world['simple'] and cls._world['workspace'] == 0:
            # actual dimensions
